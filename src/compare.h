...
const uint32_t *aData[] = {aCRC32, bCRC32, cCRC32, dCRC32};
const int nData = sizeof(aData) / sizeof(uint32_t *);

const char *aDesc[] = {"Normal    0x04C11DB7: &<<31 [  1] = poly     , [ 16] =     poly << 8 VALID ",
...
// Table-Lookup CRC
const Crc32Func_t aFunc[] = {crc32_000, crc32_001, crc32_010, crc32_011, crc32_100, crc32_101, crc32_110, crc32_111};
const int nFunc = sizeof(aFunc) / sizeof(Crc32Func_t);

uint32_t aPoly[] = {CRC32_FORWARD, CRC32_FORWARD, CRC32_REVERSE, CRC32_REVERSE};

// Formulaic CRC
const Crc32Simple_t aSimple[] = {crc32_formula_normal, crc32_formula_reflect, crc32_formula_normal, crc32_formula_reflect};

const char *aStatus[] = {"", "invalid!", "invalid!", ""};

const char *aType[] = {"Normal   ", "Reflected", "Normal   ", "Reflected"};
